...
public class Main 
{
	...
	public class Login extends JFrame 
	{
		...
		public Login() 
		{
			...
			verifyButton.setFont(new Font("Fertigo Pro", Font.PLAIN, 17));
	...
	public class ShowManagerGUI extends JFrame 
	{
		...
		public ShowManagerGUI()
		{
			...
			editShow.setFont(new Font("Fertigo Pro", Font.PLAIN, 17));
			...
			balance.setFont(new Font("Fertigo Pro", Font.PLAIN, 17));
			...
			status.setFont(new Font("Fertigo Pro", Font.PLAIN, 17));
			...
			greetingLabel.setFont(new Font("Fertigo Pro", Font.PLAIN, 17));
			...
			addSalesPerson.setFont(new Font("Fertigo Pro", Font.PLAIN, 17));
			...
			removeSalesPerson.setFont(new Font("Fertigo Pro", Font.PLAIN, 17));
			...
			salesPersonStatus.setFont(new Font("Fertigo Pro", Font.PLAIN, 17));
			...
			logoutButton.setFont(new Font("Fertigo Pro", Font.PLAIN, 17));
			...
			bookButton.addActionListener(new ActionListener()
					{
						public void actionPerformed(ActionEvent e)
						{
							if(Integer.parseInt(bBook.getText()) > 0 || Integer.parseInt(oBook.getText()) > 0)
							{
								db.connect();
								...
								try 
								{
									...
									while(rst.next())
									{
												...
												&& Integer.parseInt(oBook.getText()) <= (rst.getInt("OSale") - rst.getInt("OFilled")))
										{
											...
											int amount;
											amount = rst.getInt("BPrice") * Integer.parseInt(bBook.getText()) 
													+ rst.getInt("OPrice") * Integer.parseInt(oBook.getText());
											
											
											
											int newb = rst.getInt("BFilled") + Integer.parseInt(bBook.getText());
											int newo = rst.getInt("OFilled") + Integer.parseInt(oBook.getText());
													...
													+ "VALUES ('"+transID+"', '"+SPusername+"', '"+showBox.getSelectedItem().toString()+"', "
															+ "'"+dateBox.getSelectedItem().toString()+"',"
																	+ "'"+timeBox.getSelectedItem().toString()+"',"
																			+ "'"+Integer.parseInt(bBook.getText())+"',"
																					+ "'"+Integer.parseInt(oBook.getText())+"',"
																							+ "'"+amount+"')";
											...
											JOptionPane.showMessageDialog(null, "Successfully Booked \n"
													...
													"\nBalcony Seats :" + Integer.parseInt(bBook.getText()) +
													"\nOrdinary Seats : " + Integer.parseInt(oBook.getText()));
										}
	...
	public class AccountsClerkGUI extends JFrame
	{
		...
		public AccountsClerkGUI(String sname, String sdate, String stime) 
		{
			...
			JLabel greetingsLabel = new JLabel("Greetings !!, What would you like to do ..");
			greetingsLabel.setFont(new Font("Fertigo Pro", Font.PLAIN, 14));
			greetingsLabel.setBounds(30, 26, 336, 34);
			contentPane.add(greetingsLabel);
			
			JButton logoutButton = new JButton("Logout");
			logoutButton.setFont(new Font("Fertigo Pro", Font.PLAIN, 14));
			logoutButton.setBounds(395, 26, 107, 34);
			logoutButton.addActionListener(new ActionListener()
					{
						public void actionPerformed(ActionEvent e)
						{
			...
			label.setFont(new Font("Fertigo Pro", Font.PLAIN, 15));
			label.setBounds(30, 88, 255, 34);
			...
			logisticsLabel.setBounds(30, 152, 201, 34);
			...
			logisticsTextField.setBounds(261, 153, 187, 34);
